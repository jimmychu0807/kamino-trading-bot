...
class SolanaClient {
	...
	async signAndSendWithRetry(transactionMessage: any, maxRetries = 3): Promise<string> {
	...
	async transferSol(from: KeyPairSigner, to: Address, amountSol: number): Promise<string> {
...
export { CONFIGS, type Config, LAMPORTS_PER_SOL, SolanaClient };
